...
const CDashboard = ({ initialTab = 'dashboard' }) => {
  ...
  const totalPackagePurchases = Array.isArray(analyticsData.packageAnalytics?.popularPackages)
    ? analyticsData.packageAnalytics.popularPackages.reduce((total, pkg) => total + (pkg?.count || 0), 0)
    : 0;
            ...
            <CardBody>
              <Flex direction={{ base: "column", md: "row" }} align="center" justify="space-between">
                ...
                <Text fontSize="sm" color="gray.500" textAlign="right">
                  Based on {totalPackagePurchases} package purchases
                </Text>
              </Flex>
            </CardBody>
          </Card>
