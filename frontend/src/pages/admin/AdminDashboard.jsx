...
const AdminDashboard = () => {
  ...
  const [smsAccountForm, setSmsAccountForm] = useState({
    phoneNumber: "",
    password: "",
  });
  const [smsDeleteForm, setSmsDeleteForm] = useState({
    phoneNumber: "",
  });
      ...
      return (
        <Stack spacing={5}>
          ...
          <SimpleGrid columns={{ base: 1, xl: 3 }} spacing={5}>
                ...
                <Stack spacing={4}>
                  <FormControl isRequired>
                    ...
                    <Input
                      ...
                      onChange={handleSmsAccountFormChange("phoneNumber")}
                    />
                    <Text fontSize="xs" color={mutedText} mt={2}>
                      Ethiopian format only. Example: 0912345678 or 251912345678.
                    </Text>
                  </FormControl>
                  ...
                  <FormControl isRequired>
                    ...
                    <Input
                      ...
                      value={smsAccountForm.password}
                      onChange={handleSmsAccountFormChange("password")}
                    />
                    <Text fontSize="xs" color={mutedText} mt={2}>
                  ...
                  <Flex gap={3} justify="flex-end">
                    <Button variant="ghost" onClick={resetSmsAccountForm}>
                      {smsEditingAccount ? "Cancel Edit" : "Clear"}
                    </Button>
                    <Button
                      leftIcon={<Icon as={FiPlus} />}
                      colorScheme="cyan"
            ...
            <Card bg={cardBg} borderColor={borderColor} borderWidth="1px">
              <CardHeader>
                <Heading size="sm">Delete SMS Scholar Account</Heading>
              </CardHeader>
              <CardBody>
                <Stack spacing={4}>
                  <FormControl isRequired>
                    ...
                    <Input
                      placeholder="09XXXXXXXX or 251XXXXXXXXX"
                      value={smsDeleteForm.phoneNumber}
                      onChange={handleSmsDeleteFormChange("phoneNumber")}
                    />
                    <Text fontSize="xs" color={mutedText} mt={2}>
                      Enter the scholar phone number you want to remove.
                    </Text>
                  </FormControl>

                  {lastSmsAccount?.subscriber?.phoneNumber ? (
                    <Button
                      variant="ghost"
                      size="sm"
                      ...
                      onClick={() =>
                        setSmsDeleteForm({
                          phoneNumber:
                            lastSmsAccount?.subscriber?.phoneNumber ||
                            lastSmsAccount?.credentials?.phoneNumber ||
                            "",
                        })
                      }
                    >
                      Use latest phone number
                    </Button>
                  ) : null}

                  <Flex gap={3} justify="flex-end">
                    <Button variant="ghost" onClick={resetSmsDeleteForm}>
                      Clear
                    </Button>
                    <Button
                      colorScheme="red"
                      variant="outline"
                      onClick={handleDeleteSmsAccount}
                      isLoading={smsDeleteSubmitting}
                    >
                      Delete SMS Account
                    </Button>
                  </Flex>
            ...
            <Card bg={cardBg} borderColor={borderColor} borderWidth="1px">
              ...
              <CardBody>
                {lastSmsAccount ? (
                  <Stack spacing={4}>
                    <Box>
                      <Text fontSize="xs" color={mutedText} textTransform="uppercase" letterSpacing="0.08em">
                        Status
                      </Text>
                      <Badge colorScheme={lastSmsAccount.created ? "green" : "blue"} mt={2}>
                        {lastSmsAccount.created ? "Created" : "Updated"}
                      </Badge>
                    </Box>
                    <Box>
                      <Text fontSize="xs" color={mutedText} textTransform="uppercase" letterSpacing="0.08em">
                    ...
                    <Box>
                      ...
                      <Text fontWeight="semibold" mt={1}>
                        {lastSmsAccount.credentials?.password || "-"}
                      </Text>
                    </Box>
                    <Box>
                      <Text fontSize="xs" color={mutedText} textTransform="uppercase" letterSpacing="0.08em">
                      ...
                      <Text mt={1}>
                        {lastSmsAccount.subscriber?.status || "ACTIVE"}
                      </Text>
                    </Box>
                  </Stack>
                ) : (
                  <Stack spacing={3}>
                    <Text color={mutedText}>
                      No SMS scholar account created in this session yet.
                    </Text>
                  </Stack>
                )}
              </CardBody>
