...
const AdminTrainingMaterialList = () => {
  ...
  return (
    <Box mt={8}>
      <Text fontSize="2xl" fontWeight="bold" mb={4} color="teal.700">
            ...
            <Card key={material._id} maxW="sm" borderWidth="1px" borderRadius="md" boxShadow="md">
              <CardBody>
                <Flex align="center" justify="space-between" mb={2}>
                  ...
                  >
                    {material.type === "powerpoint" ? "PPT" : (material.type || "FILE").toUpperCase()}
                  </Tag>
                </Flex>
                ...
                <Flex gap={2}>
                  {material.type === "video" ? (
                    ...
                    <Button
                      ...
                      rel={canViewInBrowser(material.type) ? "noreferrer" : undefined}
